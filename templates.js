...
this["Handlebars"]["templates"]["chartjsInteractive"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "      <button class=\"chart-button "
    + alias2(alias1((depth0 != null ? lookupProperty(depth0,"type") : depth0), depth0))
    + "-chart\" data-chart-type=\""
    + alias2(alias1((depth0 != null ? lookupProperty(depth0,"type") : depth0), depth0))
    + "\">\n        <span class=\"icon\"><img src=\"assets/"
    + alias2(alias1((depth0 != null ? lookupProperty(depth0,"type") : depth0), depth0))
    + "-chart-icon.png\"/></span>\n        <span class=\"title\">"
    + alias2(alias1((depth0 != null ? lookupProperty(depth0,"type") : depth0), depth0))
    + "</span>\n      </button>\n";
  ...
  return "<div class=\"chart__inner component__inner\">\n"
    ...
    + "  <canvas id=\"myChart"
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"_id") || (depth0 != null ? lookupProperty(depth0,"_id") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(alias1,{"name":"_id","hash":{},"data":data,"loc":{"start":{"line":3,"column":21},"end":{"line":3,"column":28}}}) : helper)))
    + "\" class=\"chart__widget component__widget\" width=\"800\" height=\"400\" style=\"max-width:800px; max-height:400px;\"></canvas>\n  <div id=\"axisSelections\" style=\"display: block;\">\n    <div id=\"xAxisSelector\" class=\"axis-selector\">\n      <label for=\"xAxis\">X-Axis:</label>\n      <select id=\"xAxis\">\n        <!-- Options will be dynamically added based on selected chart type -->\n      </select>\n    </div>\n    <div id=\"yAxisSelector\" class=\"axis-selector\">\n      <label for=\"yAxis\">Y-Axis:</label>\n      <select id=\"yAxis\">\n        <!-- Options will be dynamically added based on selected chart type -->\n      </select>\n    </div>\n    <div id=\"pointColorSelector\" class=\"axis-selector\">\n      <label for=\"pointColor\">Point/Bar colour:</label>\n      <select id=\"pointColor\">\n        <!-- Options will be dynamically added based on selected chart type -->\n      </select>\n    </div>\n    <div id=\"binCountSelector\" class=\"bin-selector\">\n       <label for=\"binCount\">Bin Count:</label>\n       <input type=\"number\" id=\"binCount\" min=\"1\" max=\"10\" value=\"5\">\n    </div>\n  </div>\n  <div id=\"chartType\" class=\"chart-type-selector\">\n"
    + ((stack1 = lookupProperty(helpers,"each").call(alias1,(depth0 != null ? lookupProperty(depth0,"availableChartTypes") : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":29,"column":4},"end":{"line":34,"column":13}}})) != null ? stack1 : "")
    + "  </div>\n</div>";
